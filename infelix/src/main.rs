...
static COOL_TEXT: &str = r#"   ______  __    __  ________  ________  __        ______  __    __ 
  /      |/  \  /  |/        |/        |/  |      /      |/  |  /  |
  $$$$$$/ $$  \ $$ |$$$$$$$$/ $$$$$$$$/ $$ |      $$$$$$/ $$ |  $$ |
    $$ |  $$$  \$$ |$$ |__    $$ |__    $$ |        $$ |  $$  \/$$/ 
    $$ |  $$$$  $$ |$$    |   $$    |   $$ |        $$ |   $$  $$<  
...
fn main() {
    ...
    keyPath.push_str(r#"\infelix.key"#);
    ...
    let keyRepresentation: String = key
        .iter()
        .map(|byte| byte.to_string())
        .collect::<Vec<String>>()
        .join("-");

    println!("Key: {}", keyRepresentation);
